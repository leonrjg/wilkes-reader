...
export function useDomDocumentSelection({ rootRef, mapSelection, dismissOnCollapsedSelection = false, }) {
    ...
    useEffect(() => {
        if (!dismissOnCollapsedSelection)
            return;
...
//# sourceMappingURL=useDomDocumentSelection.js.map
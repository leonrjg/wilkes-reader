...
function collectText(root) {
    ...
    for (let node = walker.nextNode(); node; node = walker.nextNode()) {
        ...
        if (seenAny && block !== previousBlock)
            text += "\n";
...
function pointFor(pieces, offset) {
...
export function findMatchRanges(root, query) {
 ...
 */
export function useMarkdownFind({ rootRef, content, query, isOpen, currentIdx, onMatchCount }) {
    useEffect(() => {
        if (!ensureHighlights()) {
...
//# sourceMappingURL=useMarkdownFind.js.map
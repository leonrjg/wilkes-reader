...
/** The vertical anchor of the viewport, independent of zoom/width. */
...
export declare function savePdfScrollPosition(url: string, position: PdfScrollPosition): void;
export declare function readPdfScrollPosition(url: string): PdfScrollPosition | null;
//# sourceMappingURL=pdfScrollMemory.d.ts.map